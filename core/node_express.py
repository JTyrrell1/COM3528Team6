...
class NodeExpress(node.Node):
	...
	def set_tail(self,tail):
		self.output.cosmetic_joints[1] = tail

	def set_eyes(self,eye1,eye2):
		self.output.cosmetic_joints[2] = eye1
		self.output.cosmetic_joints[3] = eye2

	def set_ears(self,ear1,ear2):
		self.output.cosmetic_joints[4] = ear1
		self.output.cosmetic_joints[5] = ear2

	def set_leds(self,color_change):
		for x in range(0, 5):
			self.output.illum[x] = color_change[x]
