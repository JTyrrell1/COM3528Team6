...
def miro_emotion_loop(app_state: AppState):
    ...
    print("MiRo emotion loop started.")

    try:
        while not rospy.is_shutdown():
            key = get_pressed_key()
            if key == 't':
                if app_state.current_mode != "listening":
                    app_state.current_mode = "listening"
                else:
            ...
            elif mode == "listening" and listening_active is False:
                listening_enter()
            elif mode != "listening" and listening_active is True:
                listening_exit()
            else:
